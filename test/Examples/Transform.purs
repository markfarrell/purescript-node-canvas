...
{-- Mozilla Canvas API Example: https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/transform --}
main :: Effect Unit
main = 
  let
    width = 250.0
  ...
  in 
    void $ launchAff $ do
      ...
      _ <- Canvas.transform context 1.0 0.2 0.8 1.0 0.0 0.0
